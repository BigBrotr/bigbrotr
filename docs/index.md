...
-   :material-database:{ .lg .middle } **PostgreSQL Backend**
    ...
    38 stored functions, current-state tables, analytics tables, NIP-85 rank tables, and content-addressed metadata with SHA-256 deduplication.
