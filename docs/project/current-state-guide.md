...
This file is the implementation-aligned overview for BigBrotr.
...
- current architectural decisions live in
  [Decision Record](../appendices/decision-record.md);
- the canonical docs entrypoint is [Project Orientation](index.md).
...
- canonical operator guidance in `docs/`
...
| `docs/` | canonical maintained documentation site |
...
These documentation files each serve a different role:

| File | Role |
|------|------|
| `README.md` | public-facing summary and repository entry point |
| `docs/project/current-state-guide.md` | current-state implementation overview |
| `docs/project/repository-bible.md` | deeper repository reference |
| `docs/appendices/nostr-nips-analysis.md` | protocol-analysis reference |
| `docs/appendices/decision-record.md` | current architectural decision record |

Use this guide when you need a current implementation map.
Use the [Decision Record](../appendices/decision-record.md) when you need the
current architectural rationale behind the executed redesign.
