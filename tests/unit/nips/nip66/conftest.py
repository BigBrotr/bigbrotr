...
@pytest.fixture
def complete_rtt_logs() -> Nip66RttMultiPhaseLogs:
    """Complete RTT logs with partial success (write failed)."""
    return Nip66RttMultiPhaseLogs(
        open_success=True,
        open_reason=None,
        read_success=True,
        read_reason=None,
...
@pytest.fixture
def rtt_all_success_logs() -> Nip66RttMultiPhaseLogs:
...
@pytest.fixture
def rtt_open_failed_logs() -> Nip66RttMultiPhaseLogs:
