...
from bigbrotr.nips.nip66.logs import (
    Nip66DnsLogs,
    Nip66GeoLogs,
    Nip66HttpLogs,
    Nip66NetLogs,
...
class TestNip66RttMultiPhaseLogsValidation:
    """Test Nip66RttMultiPhaseLogs semantic validation rules."""
...
class TestNip66RttMultiPhaseLogsSuccessReasonConstraints:
...
class TestNip66RttMultiPhaseLogsCascadeConstraints:
...
class TestNip66RttMultiPhaseLogsSerialization:
    """Test Nip66RttMultiPhaseLogs serialization methods."""
    ...
    def test_from_dict_success(self) -> None:
        ...
        logs = Nip66RttMultiPhaseLogs.from_dict(data)
        assert logs.open_success is True
        assert logs.read_success is True
        assert logs.write_success is True
...
class TestNip66RttMultiPhaseLogsImmutability:
    """Test that Nip66RttMultiPhaseLogs is frozen/immutable."""
