...
def fetch_metadata(
    ...
    """Nip11FetchMetadata instance with successful fetch."""
    return Nip11FetchMetadata(data=fetch_data, logs=fetch_logs_success)
...
def fetch_metadata_failed(
    ...
    """Nip11FetchMetadata instance with failed fetch."""
    return Nip11FetchMetadata(data=fetch_data_empty, logs=fetch_logs_failure)
...
def nip11_failed(
    relay: Relay,
    fetch_metadata_failed: Nip11FetchMetadata,
) -> Nip11:
