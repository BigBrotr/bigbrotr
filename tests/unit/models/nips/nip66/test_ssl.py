...
- Nip66SslMetadata.ssl() - async SSL check with clearnet validation
"""
...
from models.nips.nip66.ssl import CertificateExtractor, Nip66SslMetadata
    ...
    def test_success_returns_valid_cert(
        ...
        with patch("socket.create_connection") as mock_conn:
            ...
            with patch("ssl.create_default_context") as mock_ctx:
                ...
                mock_ssl_socket.getpeercert.side_effect = [
                    mock_certificate_dict,
                    mock_certificate_binary,
                ]
...
class TestNip66SslMetadataSslAsync:
    ...
    async def test_uses_explicit_port(self, relay_with_port: Relay) -> None:
        ...
        with patch.object(Nip66SslMetadata, "_ssl", return_value=ssl_result) as mock_ssl:
            await Nip66SslMetadata.ssl(relay_with_port, 10.0)
