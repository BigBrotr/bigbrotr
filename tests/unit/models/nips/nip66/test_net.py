...
- Nip66NetMetadata.net() - async network lookup with clearnet validation
...
from models.nips.nip66.net import Nip66NetMetadata
...
class TestNip66NetMetadataNetAsync:
    ...
    async def test_i2p_raises_value_error(
        ...
        with pytest.raises(ValueError, match="net lookup requires clearnet"):
            await Nip66NetMetadata.net(i2p_relay, mock_asn_reader)
    ...
    async def test_loki_raises_value_error(
        ...
        with pytest.raises(ValueError, match="net lookup requires clearnet"):
            await Nip66NetMetadata.net(loki_relay, mock_asn_reader)
    ...
    async def test_dual_stack_passed_to_net(
        ...
        with (
            ...
            await Nip66NetMetadata.net(relay, mock_asn_reader)
