...
class TestConstruction:
    ...
    def test_with_none(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value=None)  # type: ignore[arg-type]
        assert m.value == {}
    ...
    def test_with_nested(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"outer": {"inner": "value"}})
        assert m.value["outer"]["inner"] == "value"

    def test_with_list_values(self):
        """Constructs with list values in dict."""
        m = Metadata(
            type=MetadataType.NIP11_INFO, value={"items": [1, 2, 3], "names": ["a", "b", "c"]}
        )
    ...
    def test_with_mixed_types(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value=data)
...
class TestGetMethods:
    ...
    def test_get_with_default(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"name": "test"})
    ...
    def test_get_wrong_type_returns_default(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"name": 123})
    ...
    def test_get_nested_outer_not_dict(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"outer": "not_a_dict"})
    ...
    def test_get_deep_nested(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"a": {"b": {"c": "deep"}}})
    ...
    def test_get_deep_nested_with_default(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"a": {"b": {}}})
    ...
    def test_get_bool_type(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"enabled": True})
...
class TestSanitize:
    ...
    def test_null_bytes_rejected(self):
        ...
        with pytest.raises(ValueError, match="null bytes"):
            Metadata(type=MetadataType.NIP11_INFO, value={"text": "hello\x00world"})

    def test_deeply_nested_sanitization(self):
        """Deeply nested structures are sanitized correctly."""
        m = Metadata(type=MetadataType.NIP11_INFO, value={"l1": {"l2": {"l3": {"l4": "value"}}}})
...
class TestFromDbParams:
    ...
    def test_roundtrip(self):
        ...
        original = Metadata(type=MetadataType.NIP11_INFO, value={"name": "test", "value": 123})
...
class TestEquality:
    ...
    def test_equal(self):
        ...
        m1 = Metadata(type=MetadataType.NIP11_INFO, value={"key": "value"})
        m2 = Metadata(type=MetadataType.NIP11_INFO, value={"key": "value"})
        assert m1 == m2

    def test_different_value(self):
        """Metadata with different data are not equal."""
        m1 = Metadata(type=MetadataType.NIP11_INFO, value={"key": "value1"})
        m2 = Metadata(type=MetadataType.NIP11_INFO, value={"key": "value2"})
        assert m1 != m2
...
class TestNormalization:
    ...
    def test_none_in_lists_removed(self):
        ...
        m = Metadata(type=MetadataType.NIP11_INFO, value={"items": [1, None, 2, None, 3]})
        assert m.value == {"items": [1, 2, 3]}

    def test_falsy_values_preserved(self):
        """Falsy values (False, 0, '') are preserved, only None/empty containers removed."""
        m = Metadata(type=MetadataType.NIP11_INFO, value={"enabled": False, "count": 0, "name": ""})
    ...
    def test_list_becomes_empty_after_filtering(self):
        ...
        m = Metadata(
            type=MetadataType.NIP11_INFO, value={"items": [None, {}, [], None], "real": "data"}
        )
