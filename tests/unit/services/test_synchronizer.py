...
class TestRelayType:
    """Tests for Relay dataclass from models."""
    ...
    def test_relay_url_parsing(self) -> None:
        ...
        relay = Relay("wss://relay.example.com")
        assert "relay.example.com" in str(relay.url)

    def test_relay_url_normalization(self) -> None:
        """Test URL normalization."""
        relay = Relay("WSS://RELAY.EXAMPLE.COM/")
        # Normalized to lowercase with scheme, without trailing slash
