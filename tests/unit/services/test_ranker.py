...
class TestRankerConfig:
    ...
    def test_ranker_graph_rejects_non_integer_iterations_aliases(self, value: object) -> None:
        with pytest.raises(ValueError, match=r"iterations: expected integer, got"):
            RankerGraphConfig(iterations=value)
    ...
    def test_ranker_facts_stage_rejects_non_integer_batch_size_aliases(self, value: object) -> None:
        with pytest.raises(ValueError, match=r"batch_size: expected integer, got"):
    ...
    def test_ranker_facts_stage_rejects_non_integer_max_addressable_rows_aliases(
        self, value: object
    ) -> None:
    ...
    @pytest.mark.parametrize("value", ["20", 20.0])
    def test_nested_graph_rejects_non_integer_iterations_aliases(self, value: object) -> None:
        with pytest.raises(ValueError, match=r"iterations: expected integer, got"):
            RankerConfig.model_validate({"graph": {"iterations": value}})
    ...
    @pytest.mark.parametrize("value", ["2000", 2000.0])
    def test_nested_facts_stage_rejects_non_integer_max_addressable_rows_aliases(
        self, value: object
    ) -> None:
        with pytest.raises(ValueError, match=r"max_addressable_rows: expected integer, got"):
