# tests/system/deployments/bigbrotr

`bigbrotr` deployment-stack baseline certification.

## What Lives Here

- full compose startup/readiness proof for the canonical full-archive profile;
...
- prove the real `bigbrotr` compose topology, not a reduced synthetic subset;
