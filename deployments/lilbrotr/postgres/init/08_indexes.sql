 ...
 *
 * Performance indexes for tables, summary tables, and materialized views.
 * Every materialized view requires a UNIQUE index for
 * REFRESH MATERIALIZED VIEW CONCURRENTLY to work.
 * Summary tables have PRIMARY KEYs (defined in 06) but may need
...
-- ==========================================================================
-- MATERIALIZED VIEW INDEXES: daily_counts
-- ==========================================================================
