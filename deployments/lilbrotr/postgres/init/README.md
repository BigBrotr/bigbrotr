# `lilbrotr/postgres/init`

Generated PostgreSQL bootstrap package for the `lilbrotr`
lightweight-archive reference deployment.
...
- Keep the lightweight-archive package honest with the profile-specific SQL
  templates and the privileges assumed by the application and deployment docs.
