 ...
 * content_values, and sigs arrays are accepted but not persisted.
 *
 * Parameters:
 ...
 *   p_content_values   - Array of event content strings (accepted but not stored)
...
CREATE OR REPLACE FUNCTION event_insert(
    ...
    p_content_values TEXT [],  -- Accepted but NOT stored
 ...
 * so the lightweight storage behavior of event_insert() applies here too.
 *
