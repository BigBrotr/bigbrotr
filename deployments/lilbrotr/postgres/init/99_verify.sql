...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Analytics Summary Tables (6):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Current Refresh Functions (4):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Analytics Summary Refresh Functions (8):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Matview Refresh Functions (4):';
    ...
    RAISE NOTICE '      LilBrotr aims for exact parity when metrics are derivable from tagvalues, and best-effort otherwise.';
