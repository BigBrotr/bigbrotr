...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Roles:';
    RAISE NOTICE '  lilbrotr_writer (DML + EXECUTE), lilbrotr_reader (SELECT + EXECUTE + pg_monitor)';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Note: Event table has all 8 columns; tags, content, and sig are nullable (always NULL).';
    RAISE NOTICE '      Tagvalues is computed at insert time. ~60%% disk savings vs full storage.';
    RAISE NOTICE '============================================================================';
END $$;
