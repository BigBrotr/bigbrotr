 ...
 *
 * Refreshes the events_replaceable_latest view concurrently.
 * Schedule: Daily or as needed.
 */
 ...
 *
 * Refreshes the events_addressable_latest view concurrently.
 * Schedule: Daily or as needed.
 */
...
BEGIN
    ...
    PERFORM events_replaceable_latest_refresh();
    PERFORM events_addressable_latest_refresh();
