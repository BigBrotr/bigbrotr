...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Roles:';
    RAISE NOTICE '  writer (DML + EXECUTE), reader (SELECT + EXECUTE + pg_monitor + service_state DML), refresher (derived-state maintainer)';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '  none (shared storage keeps retention policy out of the base schema)';
    RAISE NOTICE '';
    RAISE NOTICE 'Current Refresh Functions (3):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Analytics And Operational-Fact Refresh Functions (13):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'NIP-85 Incremental Refresh Functions (4):';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Periodic Refresh Functions (3):';
