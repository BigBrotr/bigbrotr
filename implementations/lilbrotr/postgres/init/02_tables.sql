...
-- ==========================================================================
-- events: Lightweight Nostr event storage (no tags/content/sig)
-- ==========================================================================
...
-- computed at insert time by events_insert() using tags_to_tagvalues(),
...
COMMENT ON TABLE events IS 'Lightweight Nostr events (tagvalues only, no tags/content/sig)';
...
COMMENT ON COLUMN events.tagvalues IS 'Tag values computed at insert time for GIN indexing';
