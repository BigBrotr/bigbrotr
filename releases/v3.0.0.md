...
|                                                                           |
|   +--------+     +--------+     +-------------+     +---------+           |
|   |  Pool  |     | Brotr  |     | BaseService |     | Metrics |           |
|   |(conn)  |---->|(db api)|     | (lifecycle) |     |(prom)   |           |
|   +--------+     +--------+     +-------------+     +---------+           |
|                                        |                                  |
|                                   +----+----+                             |
|                                   | Logger  |                             |
...
+---------------------------------------------------------------------------+
|                                                                           |
|   Event  Relay  EventRelay  Metadata  Nip11  Nip66  NetworkType           |
|   MetadataType  RelayMetadata                                             |
|                                                                           |
...
events:
  ...
  kinds: [2, 3, 10002]            # Event kinds to scan
...
keys:
  ...
  # Required for write tests and publishing events
