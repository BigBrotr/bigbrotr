...
class RankerSyncConfig(BaseModel):
    ...
    @field_validator("max_batches", mode="before")
    @classmethod
    def require_integer_max_batches(cls, value: Any, info: ValidationInfo) -> int | None:
        if value is None:
            return None
        return _require_integer(value, str(info.field_name))
...
class RankerFactsStageConfig(BaseModel):
    ...
    @field_validator("max_event_rows", mode="before")
    @classmethod
    def require_integer_max_event_rows(cls, value: Any, info: ValidationInfo) -> int | None:
        if value is None:
            return None
        return _require_integer(value, str(info.field_name))
    ...
    @classmethod
    def require_integer_max_identifier_rows(cls, value: Any, info: ValidationInfo) -> int | None:
        if value is None:
            return None
        return _require_integer(value, str(info.field_name))
...
class RankerCleanupConfig(BaseModel):
    ...
    @classmethod
    def require_integer_rank_runs_retention(cls, value: Any, info: ValidationInfo) -> int | None:
        if value is None:
            return None
        return _require_integer(value, str(info.field_name))
