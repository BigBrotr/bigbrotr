...
The module depends only on [bigbrotr.models][bigbrotr.models] and the standard
library, keeping it safe to import from any layer above ``models``.
...
Examples:
    ...
    relays = safe_parse(["wss://relay.example.com", "wss://nos.lol"], Relay.parse)
