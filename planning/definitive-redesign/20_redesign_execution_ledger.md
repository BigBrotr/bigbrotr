...
| 9. Repository-wide documentation rewrite | in progress | In-code/public API docs, MkDocs IA rewrite, and folder-level local README coverage are closed; only deployment/operator/contributor guides plus the final reference-alignment pass remain |
